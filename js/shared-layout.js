(function () {
  var headerTemplate = [
    ...
    '            <a href="/marketing-medico-tijuana/" class="menu-loc-link" data-match="medico">',
    ...
    '            <a href="/marketing-medico-tijuana/seo-para-medicos/">',
    ...
    '              SEO para M\u00e9dicos',
    '            </a>',
    '            <a href="/marketing-medico-tijuana/google-ads-medicos/">',
    ...
    '            </a>',
    '            <a href="/marketing-medico-tijuana/paginas-web-para-medicos/">',
    '              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',
    '              P\u00e1ginas Web para M\u00e9dicos',
    '            </a>',
    '          </div>',
    '          <div class="menu-loc-row">',
    '            <a href="/marketing-medico-guadalajara/" class="menu-loc-link" data-match="medico-gdl">',
    '              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg>',
    ...
    '          </div>',
    '          <div class="menu-loc-sub" hidden>',
    '            <a href="/marketing-medico-guadalajara/seo-para-medicos/">',
    '              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',
    '              SEO para M\u00e9dicos',
    '            </a>',
    '            <a href="/marketing-medico-guadalajara/google-ads-medicos/">',
    '              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',
    '              Google Ads para M\u00e9dicos',
    '            </a>',
    '            <a href="/marketing-medico-guadalajara/paginas-web-para-medicos/">',
    '              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',
    '              P\u00e1ginas Web para M\u00e9dicos',
    '            </a>',
    '          </div>',
    ...
    '          <a href="/marketing-cirujanos-plasticos-tijuana/" data-match="plasticos">',
    ...
    '          </a>',
    '          <a href="/marketing-dentistas-tijuana/" data-match="dentistas">',
    ...
    '      <div class="nav-dropdown-menu">',
    '        <div class="menu-loc-row">',
    '          <a href="/marketing-medico-tijuana/" class="menu-loc-link">Marketing M\u00e9dico \u00b7 Tijuana</a>',
    '          <button class="menu-loc-expand" type="button" aria-expanded="false" aria-label="Ver servicios en Tijuana">',
    '            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>',
    '          </button>',
    '        </div>',
    '        <div class="menu-loc-sub" hidden>',
    '          <a href="/marketing-medico-tijuana/seo-para-medicos/">SEO para M\u00e9dicos</a>',
    '          <a href="/marketing-medico-tijuana/google-ads-medicos/">Google Ads para M\u00e9dicos</a>',
    '          <a href="/marketing-medico-tijuana/paginas-web-para-medicos/">P\u00e1ginas Web para M\u00e9dicos</a>',
    '        </div>',
    '        <div class="menu-loc-row">',
    '          <a href="/marketing-medico-guadalajara/" class="menu-loc-link">Marketing M\u00e9dico \u00b7 Guadalajara</a>',
    '          <button class="menu-loc-expand" type="button" aria-expanded="false" aria-label="Ver servicios en Guadalajara">',
    '            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>',
    '          </button>',
    '        </div>',
    '        <div class="menu-loc-sub" hidden>',
    '          <a href="/marketing-medico-guadalajara/seo-para-medicos/">SEO para M\u00e9dicos</a>',
    '          <a href="/marketing-medico-guadalajara/google-ads-medicos/">Google Ads para M\u00e9dicos</a>',
    '          <a href="/marketing-medico-guadalajara/paginas-web-para-medicos/">P\u00e1ginas Web para M\u00e9dicos</a>',
    '        </div>',
    '      </div>',
    '    </div>',
    ...
    '      </button>',
    '      <div class="nav-dropdown-menu">',
    '        <a href="/marketing-cirujanos-plasticos-tijuana/">Cirujanos Plasticos - Tijuana</a>',
    '        <a href="/marketing-dentistas-tijuana/">Dentistas - Tijuana</a>',
    '      </div>',
    '    </div>',
    '    <a href="/blog">Blog</a>',
  ...
  var footerTemplate = [
    ...
    '        <a href="https://share.google/NoXnMDix4YjGrSeWL" target="_blank" rel="noopener noreferrer" aria-label="Google Business Profile"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-google-business"/></svg></a>',
    '        <a href="https://www.facebook.com/ActivoMedical/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-facebook"/></svg></a>',
    '        <a href="https://www.instagram.com/activomedical" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-instagram"/></svg></a>',
    '        <a href="https://www.linkedin.com/company/activo-medical" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-linkedin"/></svg></a>',
    '        <a href="https://www.pinterest.com/activomedical/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-pinterest"/></svg></a>',
    '        <a href="https://medium.com/@activomedical" target="_blank" rel="noopener noreferrer" aria-label="Medium"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="/Assets/Icons/social-sprite.svg#icon-medium"/></svg></a>',
    '      </div>',
    '    </div>',
    '    <div>',
    '      <h3>Servicios</h3>',
